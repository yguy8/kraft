...
export const Heading = () => {
    ...
    return(
        <div className="max-w-3xl">
            ...
            Tu conocimiento, <span className="text-blue-800 dark:text-orange-500">conectado.</span>
            </h1>

            <p className="max-w-2xl mx-auto text-lg sm:text-xl md:text-2xl font-medium mt-6 text-slate-600 dark:text-gray-200">
            Bienvenido a <span className="underline decoration-blue-500 font-bold">Kraft</span>: el espacio donde tus ideas se entrelazan y fluyen.
            </p>
            {isLoading && (
